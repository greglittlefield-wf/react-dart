  ...
  group('React component lifecycle:', () {
    group('default props', () {
      ...
      group('are merged into props by the time the Dart Component is rendered when', () {
        ...
        test('the default props are overridden', () {
          var props =
              getDartComponentProps(render(DefaultPropsTest({'defaultProp': 'overridden'})));
          expect(props, containsPair('defaultProp', 'overridden'));
        });
  ...
  group('React component lifecycle:', () {
    ...
    test('does not call getChildContext when childContextKeys is empty', () {
      ...
      var instance = react_dom.render(
          ContextWrapperWithoutKeys({'foo': false}, LifecycleTestWithContext({})), mountNode);
    ...
    test('calls getChildContext when childContextKeys exist', () {
      var mountNode = new DivElement();
      var instance =
          react_dom.render(ContextWrapper({'foo': false}, LifecycleTestWithContext({})), mountNode);
    ...
    test('receives updated context with correct lifecycle calls', () {
      ...
      var mountNode = new DivElement();
      react_dom.render(
          ContextWrapper({'foo': false}, LifecycleTestWithContext(initialPropsWithRef)), mountNode);
      ...
      react_dom.render(
          ContextWrapper({'foo': true}, LifecycleTestWithContext(newPropsWithRef)), mountNode);
...
class _LifecycleTest extends react.Component with LifecycleTestHelper {
  ...
  void componentWillUpdate(nextProps, nextState) => lifecycleCall('componentWillUpdate',
  ...
  void componentDidUpdate(prevProps, prevState) => lifecycleCall('componentDidUpdate',
