...
class SimpleComponent extends react.Component {
  ...
  componentDidMount() {
    customAssert("ref to span return span ",
        (react_dom.findDOMNode(ref("refToSpan")) as SpanElement).text == "Test");
    customAssert("findDOMNode works on this", react_dom.findDOMNode(this) != null);
    customAssert(
        "random ref resolves to null", react_dom.findDOMNode(ref("someRandomRef")) == null);
  }
  ...
  render() => react.div({}, [
        ...
        react.button({
          'key': 'button1',
          'className': 'btn btn-primary',
          'onClick': (_) => (react_dom.findDOMNode(this) as HtmlElement).children.first.text =
              (++counter).toString()
        }, 'Increase counter'),
        react.br({'key': 'br'}),
        ...
        react.button({
          ...
          'className': 'btn btn-primary',
          'onClick': (_) =>
              window.alert((this.ref('refToElement') as _ChildComponent).counter.toString())
