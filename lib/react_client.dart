...
class ReactDartComponentFactoryProxy<TComponent extends Component>
  ...
  ReactElement build(Map props, [List childrenArgs = const []]) {
    ...
    return reactComponentFactory(
        generateExtendedJsProps(props, children, defaultProps: defaultProps), children);
  }
...
final ReactDartInteropStatics _dartInteropStatics = (() {
  ...
  Component initComponent(ReactComponent jsThis, ReactDartComponentInternal internal,
      ...
      zone.run(() {
        ...
        Component component = componentStatics.componentFactory()
          ..initComponentInternal(
              internal.props, jsRedraw, getRef, jsThis, _unjsifyContext(context))
          ..initStateInternal();
  ...
  void handleComponentWillReceiveProps(Component component, ReactDartComponentInternal nextInternal,
  ...
  bool handleShouldComponentUpdate(Component component, InteropContextValue nextContext) =>
      zone.run(() {
  ...
  void handleComponentWillUpdate(Component component, InteropContextValue nextContext) =>
      zone.run(() {
  ...
  void handleComponentDidUpdate(Component component, ReactDartComponentInternal prevInternal) =>
      zone.run(() {
